...
public class Test {
    public static void main(String[] args) {
        ...
        Client c0 = new Client("sakhr", "yassine", new Date(), ss.findById(2));
        cs.create(c0);
        Client c1 = new Client("sakhr", "yassine", new Date(), ss.findById(2));
        cs.create(c1);
        Client c2 = new Client("sakhr", "yassine", new Date(), ss.findById(3));
        cs.create(c2);
        Client c3 = new Client("sakhr", "yassine", new Date(), ss.findById(3));
        cs.create(c3);
        Client c4 = new Client("sakhr", "yassine", new Date(), ss.findById(3));
        cs.create(c4);
